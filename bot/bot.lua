bot = dofile('/home/nic5/inline/data/utils.lua')
json = dofile('/home/nic5/inline/data/JSON.lua')
...
help = [[متن راهنمای مالک ربات ثبت نشده است.]]
  ...
  elseif is_owner(msg) then
    help = [[
	<code>>📜راهنمای مالکان و مدیران گروه📜)</code>

*<b>[/#!]پنل مدیریت</b> --<code>دریافت تنظیمات و پنل مدیریت گروه</code>
*<b>[/#!]</b> راهنما-<code>گرفتن راهنمای دستورات</code>
*<b>[/#!]تنظیم مدیر</b>ریپلی یا شناسه یا آیدی--<code>تنظیم مالک فرعی جدید برای گروه با یوزرنیم|ریپلی|شناسه -فرد</code>
*<b>[/#!]عزل مدیر</b> ریپلی یا ایدی یا شناسه --<code>حذف مالک فرعی از گروه با یوزرنیم|ریپلی|شناسه -فرد</code>
*<b>[/#!]لیست مالکان == مالکان</b> --<code>دریافت لیست مدیران اصلی</code>
*<b>[/#!]لیست مدیران == مدیران</b> --<code>دریافت لیست مدیران فرعی گروه</code>
*<b>[/#!]تنظیم لینک</b> <code>لینک</code> <code>{لینک-گروه} --تنظیم لینک گروه</code>
*<b>[/#!]لینک</b> <code>دریافت لینک گروه</code>
*<b>[/#!]مسدود</b> ریپلی یا آیدی یا شناسه <code>اخراج کاربر با ریپلی|یوزرنیم|شناسه</code>
<b>-------------------------------</b>
...
*<b>[/#!] آزادی لیست سایلنت ==آزادی سایلنت ها</b> <code>{حذف لیست سکوت کاربران}</code>
...
*<b>[/#!]سایلنت</b> ریپلی یا شناسه یا آیدی <code>--افزودن کاربر به لیست سکوت با یوزرنیم|ریپلی|شناسه -فرد</code>
*<b>[/#!]آزاد سایلنت</b> ریپلی یا شناسه یا آیدی فرد<code>--افزودن کاربر به لیست سکوت با یوزرنیم|ریپلی|شناسه -فرد</code>
*<b>[/#!]لیست سایلنت == سایلنت ها</b> <code>--دریافت لیست کاربران حالت سکوت</code>
<b>-------------------------------</b>
...
<b>-------------------------------</b>
<code>>راهنمای دستورات متفرقه ابر-گروه[فیلترها]</code>
*<b>⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️/b> --<code>(⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️)</code>
*<b>[/#!]حدف خوشامد</b> --<code>(💥پاک کردن خوشامد تنظیم شده💥)</code>
*<b>[/#!]تنظیم نام گپ (نام)ا</b> --<code>(💥عوض کردن نام گروه💥))</code>
*<b>[/#!]آزادی بن ها == آزادی لیست بن</b> --<code>(💥آزاد کردن همه بن شده ها💥)</code>
*<b>[/#!]بن ها == لیست بن</b> --<code>(💥گرفتن لیست بن شده ها💥)</code>
*<b>[/#!]آزاد (ریپلی یا شناسه یا آیدی)ا</b> --<code>(💥آزاد کردن شخص بن شده💥)</code>
*<b>[/#!]بن (ریپلی یا شناسه یا آیدی)ا</b> --<code>(💥اخراج فرد از گروه💥)</code>
*<b>[/#!]پاک کردن (1 تا 100 ) ا</b> --<code>(💥پاک کردن پیامهای گروه حداکثر 100💥)</code>
*<b>[/#!]آیدی </b> --<code>(💥گرفتن شناسه گروه💥)</code>
*<b>[/#!]ربات</b> --<code>(جواب ربات به شما)</code>
*<b>[/#!]سنجاق (ریپلی)ا</b> --<code>(💥سنجاق کردن پیام ریپلی شده💥)</code>
*<b>[/#!]چه کسی (ریپلی یا شناسه شخص یا ایدی شخص)</b> --<code>(💥گرفتن شناسه و تعداد پیامهای شخص💥))</code>
*<b>[/#!]انلاینی</b> --<code>(💥مطمن شدن از انلاین بودن ربات💥)</code>
*<b>[/#!]شماره تصادفی</b> --<code>(💥گرفتن شماره تصادفی از یک تا پنجاه💥)</code>
*<b>[/#!]من</b> --<code>(💥برگرداندن شناسه شخص و تعداد پیامهایش💥)</code>
<b>-------------------------------</b>
