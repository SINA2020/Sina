...
local json = (loadfile "/home/nic1/inline/data/JSON.lua")()
local token = '359230568:AAExR6cFd_IH7MrbcvyoSzJqZzMVykBrwTY' --token
        ...
        for i=1, #updates.result do
          ...
          if msg.inline_query then
            local q = msg.inline_query
						if q.from.id == 378194259 or q.from.id == 333677042 then
